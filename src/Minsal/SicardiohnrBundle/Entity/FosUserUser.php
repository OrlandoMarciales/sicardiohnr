 ...
 * FosUserUser
 *
 * @ORM\Table(name="fos_user_user", uniqueConstraints={@ORM\UniqueConstraint(name="uniq_c560d761a0d96fbf", columns={"email_canonical"}), @ORM\UniqueConstraint(name="uniq_c560d76192fc23a8", columns={"username_canonical"})}, indexes={@ORM\Index(name="IDX_C560D7617DFA12F6", columns={"id_establecimiento"})})
 * @ORM\Entity
 */
class FosUserUser
{
